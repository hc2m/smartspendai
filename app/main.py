...
print("Session " , os.getenv("SESSION_SECRET_KEY"))

# this is importent after imddleware add then include_router
from app.routes import auth_google,auth,income_routes,expense_routes,refresh_token_route,dashboard_routes,transactions_route
